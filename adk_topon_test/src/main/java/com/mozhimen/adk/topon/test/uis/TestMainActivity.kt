...
class TestMainActivity : Activity(), IUtilK {
    ...
    private fun showSplashEyeAd() {
        if (com.mozhimen.adk.topon.test.helpers.SplashEyeAdHolder.splashEyeAd == null) {
            return
        }
        com.mozhimen.adk.topon.test.helpers.SplashEyeAdHolder.splashEyeAd!!.show(this@TestMainActivity, null, object : ATSplashEyeAdListener {
            override fun onAnimationStart(splashView: View) {
                ...
                val suggestedSize: IntArray = com.mozhimen.adk.topon.test.helpers.SplashEyeAdHolder.splashEyeAd!!.getSuggestedSize(applicationContext)
                ...
                zoomOutManager.startZoomOut(
                    ...
                    findViewById(R.id.content), object : SplashZoomOutManager.AnimationCallBack {
                        ...
                        override fun animationEnd() {
                            ...
                            com.mozhimen.adk.topon.test.helpers.SplashEyeAdHolder.splashEyeAd?.onFinished()
                        }
                    })
            }
            ...
            override fun onAdDismiss(isSupportEyeSplash: Boolean, errorMsg: String) {
                ...
                com.mozhimen.adk.topon.test.helpers.SplashEyeAdHolder.splashEyeAd?.destroy()
                com.mozhimen.adk.topon.test.helpers.SplashEyeAdHolder.splashEyeAd = null
            }
        })
    }
