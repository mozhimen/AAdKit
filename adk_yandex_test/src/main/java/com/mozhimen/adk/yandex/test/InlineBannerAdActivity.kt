...
import com.mozhimen.adk.yandex.AdKYandexInlineBannerProxy
...
class InlineBannerAdActivity : AppCompatActivity(R.layout.activity_inline_banner_ad) {
    ...
    @OptIn(OApiCall_BindViewLifecycle::class, OApiCall_BindLifecycle::class, OApiInit_ByLazy::class, OApiCall_ViewReady::class, OMetaData_YANDEX_ADS_APPLICATION_ID::class)
        ...
        binding.coordinatorLayout.viewTreeObserver.addOnGlobalLayoutListener(object :
            ...
            override fun onGlobalLayout() {
                ...
                _adKYandexInlineBannerProxy.apply {
                    ...
                    initBannerAd(adInfoFragment.selectedNetwork.adUnitId)
