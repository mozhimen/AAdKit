...
import com.mozhimen.adk.yandex.AdKYandexInterstitialProxy
...
class InterstitialAdActivity : BaseActivityVB<ActivityInterstitialAdBinding>() {
    ...
    private val _adKYandexInterstitialProxy by lazy { AdKYandexInterstitialProxy(this, _interstitialAdEventListener, _interstitialAdLoadListener) }
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        _adKYandexInterstitialProxy.apply {
            initInterstitialAd(selectedNetwork.adUnitId)
    ...
    private fun ActivityInterstitialAdBinding.setupUiBidding() {
        ...
        networkTextView.setOnItemClickListener { _, _, position, _ ->
            ...
            networkMenu.setStartIconDrawable(selectedNetwork.iconId)
            _adKYandexInterstitialProxy.initInterstitialAd(selectedNetwork.adUnitId)
