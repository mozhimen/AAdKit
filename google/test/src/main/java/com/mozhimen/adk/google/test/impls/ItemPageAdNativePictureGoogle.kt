 ...
 * @Version 1.0
 */
//class ItemPageAdNativePictureGoogle : BasePagingKVHKProvider<PageBundle>() {
//    override val itemViewType: Int
//        get() = CItemExtras.ITEM_PAGE_AD_NATIVE_PIC_GOOGLE_CODE
...
//                            store: String?
//                        ): NativeAdView? {
//                            val nativeAdView = LayoutInflater.from(holder.itemView.context).inflate(R.layout.item_recycler_vertical_ad_native_picture_google, null) as? NativeAdView?
//                            mediaContent?.let {
//                                nativeAdView?.findViewById<MediaView>(R.id.item_ad_native_media)?.apply {
