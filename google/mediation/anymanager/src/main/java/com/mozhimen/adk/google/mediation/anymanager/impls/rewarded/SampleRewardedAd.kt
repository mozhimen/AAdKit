package com.mozhimen.adk.google.mediation.anymanager.impls.rewarded
...
constructor(
    ...
    fun showAd(activity: Activity?) {
        ...
        val intent = Intent(activity, SampleSDKAdsActivity::class.java)
    ...
    companion object CREATOR : Creator<SampleRewardedAd> {
        override fun createFromParcel(parcel: Parcel): SampleRewardedAd {
            return SampleRewardedAd(parcel)
        }

        override fun newArray(size: Int): Array<SampleRewardedAd?> {
