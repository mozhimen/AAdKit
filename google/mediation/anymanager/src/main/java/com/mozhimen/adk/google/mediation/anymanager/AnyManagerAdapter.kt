package com.mozhimen.adk.google.mediation.anymanager
...
import com.mozhimen.adk.google.mediation.anymanager.impls.banner.SampleBannerCustomEventLoader
import com.mozhimen.adk.google.mediation.anymanager.impls.interstitial.SampleInterstitialCustomEventLoader
import com.mozhimen.adk.google.mediation.anymanager.impls.rewarded.SampleRewardedCustomEventLoader
import com.mozhimen.adk.google.mediation.anymanager.impls.nativead.SampleNativeCustomEventLoader
import com.mozhimen.adk.google.mediation.anymanager.impls.open.SampleOpenCustomEventLoader
 ...
 * @Version 1.0
 */
class AnyManagerAdapter : Adapter() {
    companion object {
        /**
    ...
    private var _bannerLoader: SampleBannerCustomEventLoader? = null
    private var _interstitialLoader: SampleInterstitialCustomEventLoader? = null
    private var _nativeLoader: SampleNativeCustomEventLoader? = null
    private var _rewardedLoader: SampleRewardedCustomEventLoader? = null
...
//    private var _rewardedInterstitialLoader: SampleRewardedInterstitialCustomEventLoader? = null
    ...
    override fun loadBannerAd(
        ...
        _bannerLoader = SampleBannerCustomEventLoader(adConfiguration, callback)
    ...
    override fun loadInterstitialAd(
        ...
        _interstitialLoader = SampleInterstitialCustomEventLoader(adConfiguration, callback)
    ...
    override fun loadNativeAd(
        ...
        _nativeLoader = SampleNativeCustomEventLoader(adConfiguration, callback)
    ...
    override fun loadRewardedAd(
        ...
        _rewardedLoader = SampleRewardedCustomEventLoader(adConfiguration, callback)
