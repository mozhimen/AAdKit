 ...
 */
/**
 * The [SampleSDKAdsActivity] is used to show sample rewarded ad by the Sample SDK.
 */
class SampleSDKAdsActivity : AppCompatActivity() {
    /**
     ...
     */
    private var sampleRewardedAd: SampleRewardedAd? = null
