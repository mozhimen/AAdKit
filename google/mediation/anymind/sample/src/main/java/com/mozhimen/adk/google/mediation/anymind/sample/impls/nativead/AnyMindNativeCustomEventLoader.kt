package com.mozhimen.adk.google.mediation.anymind.impls.nativead
...
class AnyMindNativeCustomEventLoader constructor(
    ...
    fun loadAd() {
        ...
        val loader: AnyMindNativeAdLoader =
            AnyMindNativeAdLoader(mediationNativeAdConfiguration.context)
        ...
        val request: AnyMindNativeAdRequest = AnyMindNativeAdRequest()
        ...
        if (options != null) {
            ...
            when (options.mediaAspectRatio) {
                NativeAdOptions.NATIVE_MEDIA_ASPECT_RATIO_LANDSCAPE -> request.setPreferredImageOrientation(AnyMindNativeAdRequest.IMAGE_ORIENTATION_LANDSCAPE)
                NativeAdOptions.NATIVE_MEDIA_ASPECT_RATIO_PORTRAIT -> request.setPreferredImageOrientation(AnyMindNativeAdRequest.IMAGE_ORIENTATION_PORTRAIT)
                NativeAdOptions.NATIVE_MEDIA_ASPECT_RATIO_SQUARE, NativeAdOptions.NATIVE_MEDIA_ASPECT_RATIO_ANY, NativeAdOptions.NATIVE_MEDIA_ASPECT_RATIO_UNKNOWN -> request.setPreferredImageOrientation(AnyMindNativeAdRequest.IMAGE_ORIENTATION_ANY)
                else -> request.setPreferredImageOrientation(AnyMindNativeAdRequest.IMAGE_ORIENTATION_ANY)
            }
        }
    ...
    override fun onNativeAdFetched(ad: SampleNativeAd) {
        ...
        val mapper: AnyMindNativeAdMapper = AnyMindNativeAdMapper(ad)
