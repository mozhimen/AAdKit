 ...
 */
class AnyMindNativeAdMapper(ad: SampleNativeAd) : UnifiedNativeAdMapper() {
    companion object {
        /**
         * The pixel-to-dpi scale for images downloaded from the sample SDK's URL values. Scale value is
         * set in [AnyMindNativeMappedImage].
         */
         ...
         * is added to a [Bundle] in [AnyMindNativeAdMapper].
         */
    ...
    init {
        ...
        if (ad.getIcon() != null && ad.getIconUri() != null) {
            setIcon(AnyMindNativeMappedImage(ad.getIcon()!!, ad.getIconUri()!!, SAMPLE_SDK_IMAGE_SCALE))
        }
        setAdvertiser(ad.getAdvertiser())

        if (ad.getImage() != null && ad.getIconUri() != null) {
            val imagesList: MutableList<NativeAd.Image> = ArrayList()
            imagesList.add(AnyMindNativeMappedImage(ad.getImage()!!, ad.getImageUri()!!, SAMPLE_SDK_IMAGE_SCALE))
