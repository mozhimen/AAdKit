...
//        defaultConfig = "{\"unit_id\":1333253,\"nw_firm_id\":51,\"adapter_class\":\"com.anythink.network.klevin.KlevinATSplashAdapter\",\"content\":\"{\\\"pos_id\\\":\\\"30029\\\",\\\"app_id\\\":\\\"30008\\\"}\"}";
        ...
        if (splashAd!!.isAdReady()) {
            ...
            splashAd!!.show(this@SplashAdShowActivity, container, com.mozhimen.adk.topon.test.cons.AdConst.SCENARIO_ID.SPLASH_AD_SCENARIO)
        } else {
...
//        }));
        ...
        }), com.mozhimen.adk.topon.test.cons.AdConst.SCENARIO_ID.SPLASH_AD_SCENARIO)
    }
...
//            splashAd.show(this, container, "f628c7999265cd");
    ...
    override fun onAdDismiss(entity: ATAdInfo, splashAdExtraInfo: ATSplashAdExtraInfo) {
     ...
     """.trimIndent()
        ...
        com.mozhimen.adk.topon.test.helpers.SplashEyeAdHolder.splashEyeAd = splashAdExtraInfo.atSplashEyeAd
        jumpToMainActivity()
    }
    ...
    override fun onResume() {
        ...
        if (needShowSplashAd) {
            ...
            if (splashAd!!.isAdReady) {
//                splashAd.show(this, container);
                splashAd!!.show(this, container, com.mozhimen.adk.topon.test.cons.AdConst.SCENARIO_ID.SPLASH_AD_SCENARIO)
            }
        }
    }
