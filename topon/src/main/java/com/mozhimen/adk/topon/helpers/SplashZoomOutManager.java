package com.mozhimen.adk.topon.helpers;
...
public class SplashZoomOutManager {
    ...
    private final int zoomOutMarginBottom;//悬浮窗默认距离屏幕底端的高度
    ...
    private SplashZoomOutManager(Context context) {
        int deviceWidth = Math.min(/*PxUtils.getDeviceHeightInPixel(context) */UtilKScreen.getWidth_ofDisplayMetrics_ofApp(), UtilKScreen.getHeight_ofDisplayMetrics_ofApp()/*PxUtils.getDeviceWidthInPixel(context)*/);
        ...
        zoomOutMargin = (int) UtilKDisplayMetricsWrapper.dp2px(6f);
        zoomOutMarginBottom = (int) UtilKDisplayMetricsWrapper.dp2px(100f);
        zoomOutPos = RIGHT;
     ...
     */
    @OptIn(markerClass = OApiUse_BaseApplication.class)
    public ViewGroup startZoomOut(final ViewGroup animationContainer,
        ...
        UtilKViewWrapper.removeView_ofParent(splashView);
    ...
    public ViewGroup startZoomOut(final View splash, final ViewGroup animationContainer,
        ...
        UtilKViewWrapper.removeView_ofParent(splash);
