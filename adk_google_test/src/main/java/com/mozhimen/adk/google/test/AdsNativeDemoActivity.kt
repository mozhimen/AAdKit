...
class AdsNativeDemoActivity : BaseActivityVDB<ActivityAdsNativeDemoBinding>() {
    companion object {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        vdb.refreshButton.setOnClickListener {
            refreshAd()
        }
    }
    ...
    private fun refreshAd() {
        vdb.refreshButton.isEnabled = false
        ...
        builder.forNativeAd { nativeAd ->
            ...
            vdb.adFrame.removeAllViews()
            vdb.adFrame.addView(unifiedAdBinding.root)
        }

        val videoOptions =
            VideoOptions.Builder().setStartMuted(vdb.startMutedCheckbox.isChecked).build()
        ...
        if (vc != null && mediaContent.hasVideoContent()) {
            ...
            vc.videoLifecycleCallbacks = object : VideoController.VideoLifecycleCallbacks() {
                override fun onVideoEnd() {
                    ...
                    vdb.refreshButton.isEnabled = true
                    vdb.videostatusText.text = "Video status: Video playback has ended."
                }
            }
        } else {
            vdb.videostatusText.text = "Video status: Ad does not contain a video asset."
            vdb.refreshButton.isEnabled = true
        }
    }
